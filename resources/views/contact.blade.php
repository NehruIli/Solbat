            ...
            <div class="row align-items-center">
                <div class="col-lg-5 mb-5 mb-lg-0">
                    <div class="bg-light d-flex flex-column justify-content-center px-5" style="height: 450px;">
                        ...
                        <div class="d-flex align-items-center mb-5">
                            <div class="btn-icon btn-secondary mr-4">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="mt-n1">
                                <h4>Email Us</h4>
                                <p class="m-0">help@solbat.my.id</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="section-title position-relative mb-4">
                        ...
                        <h1 class="display-4">Send message to me</h1>
                    </div>
                    <div class="contact-form">

                        <form method='post' action="{{route('contact_admin')}}">
                            @csrf

                            <div class="form-group">
                                <input type="text" class="form-control border-top-0 border-right-0 border-left-0 p-0" name = "subject"
                                    placeholder="Subject" required="required">
                            </div>
                            <div class="form-group">
                                <textarea class="form-control border-top-0 border-right-0 border-left-0 p-0" rows="5" name = "message"
